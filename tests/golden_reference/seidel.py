...
#    def pl_seidel(input, temp, output):
#        return pl_seidel_golden(input, temp, output)
...
if __name__=="__main__":
    ...
    input_2 = np.load(os.path.join("tests","golden_reference","seidel_input.npy"))
    temp_2 = np.load(os.path.join("tests","golden_reference","seidel_temp.npy"))
    output_2 = np.load(os.path.join("tests","golden_reference","seidel_output.npy"))
    print(input)
    print(input_2)
    ...
    print(output)
    print(output_2)
    print(np.equal(input,input_2).all())
    print(np.equal(temp,temp_2).all())
    print(np.equal(output,output_2).all())
