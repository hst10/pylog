...
if __name__=="__main__":
    ...
    input_2 = np.load(os.path.join("tests","golden_reference","jacobi2D_input.npy"))
    temp_2 = np.load(os.path.join("tests","golden_reference","jacobi2D_temp.npy"))
    output_2 = np.load(os.path.join("tests","golden_reference","jacobi2D_output.npy"))
